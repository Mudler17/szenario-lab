...
Phase 5.18 konsolidiert die Statusmeldungen fachlich. Die spätere und bestehende UI verwendet weiterhin die zentrale Mapping-Utility und zeigt keine technischen reason-Werte direkt an.
